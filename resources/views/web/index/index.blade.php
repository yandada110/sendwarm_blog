...
<head>
    ...
    <link href="{{__STATIC_WEB__}}/fontawesome-free-5.10.1-web/css/v4-shims.min.css" rel="stylesheet">
    <!-- CSS文件 -->
    <link href="{{__STATIC_WEB__}}/assets/css/bootstrap.min.css" rel="stylesheet" />
    <link href="{{__STATIC_WEB__}}/assets/css/paper-kit.css?v=2.2.0" rel="stylesheet" />
    <!--引入自己CSS-->
    <link href="{{__STATIC_WEB__}}/assets/css/my_settings.css" rel="stylesheet" />
    <!--谷歌统计代码-->
...
<div class="page-header section-dark" style="background-image: url('{{__STATIC_WEB__}}/assets/img/trisomy.jpg')">
    ...
    <div class="moving-clouds" style="background-image: url('{{__STATIC_WEB__}}/assets/img/clouds.png'); "></div>
    <h6 class="category category-absolute">{{$configs['base.website_keep']}}</h6>
</div>
</body>
<!--   核心JS文件   -->
<script src="{{__STATIC_WEB__}}/assets/js/core/jquery.min.js" type="text/javascript"></script>
<script src="{{__STATIC_WEB__}}/assets/js/core/popper.min.js" type="text/javascript"></script>
<script src="{{__STATIC_WEB__}}/assets/js/core/bootstrap.min.js" type="text/javascript"></script>
<!--  开关插件，完整的文档如下：http://www.jque.re/plugins/version3/bootstrap.switch/ -->
<script src="{{__STATIC_WEB__}}/assets/js/plugins/bootstrap-switch.js"></script>
<!--  Sliders插件，完整文档如下：http://refreshless.com/nouislider/ -->
<script src="{{__STATIC_WEB__}}/assets/js/plugins/nouislider.min.js" type="text/javascript"></script>
<!--  pplugin用于日期选取器，完整文档如下：https://github.com/uxsolutions/bootstrap-datepicker -->
<script src="{{__STATIC_WEB__}}/assets/js/plugins/moment.min.js"></script>
<script src="{{__STATIC_WEB__}}/assets/js/plugins/bootstrap-datepicker.js" type="text/javascript"></script>
<!-- 工具箱控制中心：视差效果、示例页面脚本等 -->
<script src="{{__STATIC_WEB__}}/assets/js/paper-kit.js?v=2.2.0" type="text/javascript"></script>
