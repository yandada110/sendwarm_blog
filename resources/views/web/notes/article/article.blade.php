            ...
            <div class="row">
                <div class="col-md-9 ml-auto mr-auto ">
                    ...
                    <div class="pagination-area">
                        {{$article_list->onEachSide(1)->appends(['search_title'=>$search_title])->links('vendor.pagination.default')}}
                    </div>
                </div>
                        ...
                        <ul class="list-unstyled">
                            @foreach($hot_article as $k => $v)
                                <li>
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-sm {{$button_color[$k]}} btn-link" onclick='addBookmark("/article/{{$v->id}}/detail")'>
