...
@section('content')
    <div class="container pt-5">
            ...
            <div class="col-sm-9" data-parallax="true" style="background-color: #f7f7f9">
                <div class="row">
                    <main class="col-sm-12 bd-content pb-4">
                        <h4 class="bd-title">{{$article->article_title}}</h4>
                        <blockquote class="blockquote text-right">
                            <p class="mb-0">最后更新时间：{{$article->updated_at}}</p>
                        </blockquote>
                        <div class="col-sm-12 m-2">
                            @foreach($tags as $k => $tag)
                                <span class="badge badge-{{Arr::random($badge_arr)}} badge-pill">{{$tag->tag_name}}</span>
                            @endforeach
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                <div class="row mt-3">
                    <div class="col-sm-12">
                        @if($articleID['previous'])
                            <a href="/article/{{$articleID['previous']}}/detail">
                                <div class="pull-left">
                        ...
                        @endif
                        @if($articleID['next'])
                            <a href="/article/{{$articleID['next']}}/detail">
                                    ...
                                    {{--<div class="card-body">--}}
                                        {{--<div class="author">--}}
                                            {{--<a href="{{$v->msg_blog_link}}" target="_blank">--}}
                                                {{--<img src="{{asset(__STATIC_WEB__)}}/assets/img/qqhead.png" alt="..." class="avatar img-raised">--}}
    ...
    <script type="text/javascript">
        ...
        var author = "{{$configs['user_info.name']}}";
